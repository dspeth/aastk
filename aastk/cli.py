...
def __casm_matrix(group, required=False):
    group.add_argument('--matrix', action='store_true', required=required,
                       help='Alignment matrix will be constructed and matrix (.npy) and metadata (.json) will be stored')
...
def __embed(group, required=False):
    group.add_argument('--embed', action='store_true', required=required,
                       help='TSNE embedding and clustering; matrix_path and metadata_matrix must be passed to application')
...
def __plot(group, required=False):
    group.add_argument('--plot', action='store_true', required=required,
                       help='Plot early embedding and full embedding clusters')
